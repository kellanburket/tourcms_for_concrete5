<?php
	...
	Loader::library('site_config', 'tourcms_custom_widgets');
	Loader::library('functions', 'tourcms_custom_widgets');
	Loader::library('video_embed/video_embed', 'tourcms_custom_widgets');
	Loader::library('tourcms', 'tourcms_custom_widgets');
...
// Other miscellaneous settings
	...
	// Code root (configured at the top of this file)
